...
sources:
  - citation: "Weilkiens T and Molnár V (2026). The SysML v2 Book, 2026-07 release. MBSE4U. Chapter 26, pages 170 to 177."
    raw: sysmlv2.pdf
related:
  - sysml2-actions
...
always executed after another (Ch 26, p 170). Successions can be
...
ordering. The recommended multiplicities are (Ch 26, pp 172 to 173):
...
not add semantics (Ch 26, p 175). Use `fork` and `join` for
...
present for each execution of the merge (Ch 26, p 175).
...
conditions in the same group evaluate to false (Ch 26, p 177).
...
by earlier unconditional successions perform (Ch 26, p 177).
