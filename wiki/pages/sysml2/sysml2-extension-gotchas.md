...
sources:
  - citation: "Weilkiens T and Molnár V (2026). The SysML v2 Book, 2026-07 release. MBSE4U. Chapter 41 Section 41.2, pages 327 to 329."
    raw: sysmlv2.pdf
related:
...
the first form and miss the second (Ch 41.2, p 328). The
...
nothing, silently and without an error message** (Ch 41.2, p 328).
...
added, and there is no error message** (Ch 41.2, p 329).
...
mechanism for a heavyweight DSL (Ch 41.2, p 329):
