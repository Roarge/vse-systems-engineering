<!-- Generated by /vse-wiki-index on 2026-08-07T07:25:36Z. Do not hand-edit. -->
...
**Total pages:** 130.  **Total layers:** 11.  **Referencing skills:** 21.
...
| Slug | Title | Type | Summary | Referenced by |
|---|---|---|---|---|
| `architectural-analysis-workflow` | Architectural Analysis and Trade Studies workflow (§6) | process | Turning a System User Story set into a resolved architecture through trade studies, per §6 | vse-companion-overview, architecture-design, story-orchestrator |
| `architectural-design-workflow` | Architectural Design workflow (§7) | process | Decomposing the resolved architecture into subsystems and allocating the specification down, per §7 | vse-companion-overview, architecture-design, story-orchestrator |
| `base-architecture-corollaries` | Base Architecture: Forward-Going Stories and the Reverse-Engineering Guard | concept | Decisions that pre-exist the project, forward-going stories, and the reverse-engineering guard | vse-companion-overview, story-orchestrator, needs-and-requirements, architecture-design, attention-regime, project-setup |
...
| `system-stories-workflow` | System Requirements Definition and Analysis workflow (§5) | process | Translating stakeholder intent into a verifiable system-level specification, per §5 | vse-companion-overview, needs-and-requirements, story-orchestrator, architecture-design |
| `user-story-canonical-artefact` | User Story as Canonical Artefact (§1) | concept | The User Story is the elementary unit of stakeholder intent in the VSE methodology | vse-companion-overview, story-orchestrator, needs-and-requirements |
