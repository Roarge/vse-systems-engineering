...
[methodology reminder, agent discipline (§2.6 rule 7)]
This prompt may be asking for stories, stakeholders, or concerns to be
synthesised from pre-existing context. Per §2.1 corollary 2 and §2.6
rule 7, do not auto-generate context stories or reverse-engineer Base
Architecture justifications. Confirm intent first when the user wants
context artefacts deliberately, and mark them as context rather than as
forward-going output.
EOF
fi
